#Step 0: input
filepath <- paste0(getwd(),"/")         # set working directory if executed from somewhere else besides directory with RawData
#filepath <- ""
#setwd(filepath)
num.case <- 30
...
cutoff.numModes = 300
POD.case = 1
dir.create("POD_result") #for dat files of POD 
