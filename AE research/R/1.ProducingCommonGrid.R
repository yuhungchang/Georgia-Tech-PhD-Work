...
for (i in 1:num.case){
  ...
  #Coordinate[[i]] <- read.table(paste0(i,"/Week", week, "_", i, "_2.dat",sep=""), header = FALSE, skip = 15, sep = '\t', colClasses=rep("numeric",14), comment.char = "")[,1:2]
  Coordinate[[i]] <- read.table(paste0(i,"/002.dat",sep=""), header = FALSE, skip = 15, sep = '\t', colClasses=rep("numeric",14), comment.char = "")[,1:2]
